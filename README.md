...
```kotlin
dependencies {
  implementation("de.kempmobil.ktor.mqtt:mqtt-core:0.6.0")
  implementation("de.kempmobil.ktor.mqtt:mqtt-client:0.6.0")
}
```
...
```kotlin
dependencies {
  implementation("de.kempmobil.ktor.mqtt:mqtt-client-ws:0.6.0")
