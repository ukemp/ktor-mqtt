...
internal fun ByteReadPacket.readConnect(): Connect {
    ...
    return Connect(
        ...
        topicAliasMaximum = properties.single(),
        requestResponseInformation = properties.single<RequestResponseInformation>(),
        requestProblemInformation = properties.single<RequestProblemInformation>(),
